...
public final class FragmentModule_ProvidesFragmentFactory implements Factory<Fragment> {
  ...
  public static FragmentModule_ProvidesFragmentFactory create(FragmentModule module) {
  ...
  public static Fragment proxyProvidesFragment(FragmentModule instance) {
    return Preconditions.checkNotNull(
        instance.providesFragment(), "Cannot return null from a non-@Nullable @Provides method");
  }
}
